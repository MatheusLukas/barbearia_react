export function Footer() {
  return (
    <div className="bg-white w-full flex flex-col justify-center items-center gap-4">
      <div className="container-footer flex flex-col justify-center items-center gap-4 sm:grid sm:grid-cols-2 sm:place-items-center h-[500px]">
        <div className="text-center">
          ...
          <p className="sm:w-[28ch] w-[500px] text-[20px] sm:text-lg">
        ...
        <div className="text-center">
          ...
          <p className="sm:w-[20ch] w-[500px] text-[20px] sm:text-lg">
            Segunda à Sexta das 8h as 12h e 13h as 18h
          </p>
        </div>
        ...
        <div className="flex items-center justify-center sm:col-span-2">
          <iframe
            ...
            height="300"
            className="border:0 w-[500px] sm:w-[500px] lg:w-[900px]"
            loading="lazy"
          ></iframe>
        </div>
      </div>
